    ...
    <div className="bg-[#1d1d1d] flex flex-col   overflow-x-hidden relative  snap-start ">
      <div className=" px-[50px] flex flex-col h-[100vh] justify-between ">
        <div className="flex flex-[0.4]">
          ...
          <div className=" cursor-pointer ml-[170px]   text-[#46acd1] ">
            {/* Button */}
            <button className=" border-2 py-[10px] px-[36px] mt-[130px] shadow-md shadow-[#46acd1]  border-[#46acd1] bg-transparent text-[18px] font-semibold leading-10 tracking-[4px]">
        ...
        <div className="flex-[0.6]">
          <div>
            ...
            <div className="text-white grid gap-[25px] grid-cols-3">
              <div className="Wrap ">
                <img
                  src={A2zone}
                  alt="ProjectImage"
